    ...
    <section id="about" className="py-20 bg-white dark:bg-gray-800">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto text-lg text-gray-700 dark:text-gray-300">
          <p className="mb-4">
            Hello! Im Dafina, a passionate web developer with experience in creating beautiful and functional
            websites. I specialize in front-end development using React and Next.js, with a keen eye for design and user
            experience.
          </p>
          <p>
            When Im not coding, you can find me exploring new technologies, contributing to open-source projects, or
